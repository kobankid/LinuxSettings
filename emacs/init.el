...
;;load-path
(add-to-list 'load-path "/usr/bin/global")
(add-to-list 'load-path "/Users/kobankid/.emacs.d/elpa/async-20181224.454")
(add-to-list 'load-path "/Users/kobankid/.emacs.d/elpa/helm-core-20190406.1826/")
(add-to-list 'load-path "/Users/kobankid/.emacs.d/elpa/helm-20190405.1842/")
(add-to-list 'load-path "/Users/kobankid/.emacs.d/elisp/")
(add-to-list 'load-path "/home/kobankid/.emacs.d/elisp/")
...
;;Key settings
;; (define-key global-map [?\M-Â¥] "\\")		            ;;Command "option+Â¥" is "\".
(global-set-key "\M-\\" 'redo)                             ;;redo
...
(require 'recentf)
(require 'recentf-ext)
(setq recentf-max-saved-items 2000) ;; 2000ãã¡ã¤ã«ã¾ã§å±¥æ­´ä¿å­ãã
(setq recentf-auto-cleanup 'never)  ;; å­å¨ããªããã¡ã¤ã«ã¯æ¶ããªã
